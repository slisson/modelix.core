...
data class MPSRepositoryAsNode(val repository: SRepository) : IDefaultNodeAdapter {
    ...
    private fun throwTemplateNodeRequired(): Nothing {
        // Module name and ID is required when creating a module
    ...
    override fun addNewChild(role: IChildLink, index: Int, templateNode: INode): INode {
        return role.switch<IChildLink, INode>()
            .case(BuiltinLanguages.MPSRepositoryConcepts.Repository.modules) {
