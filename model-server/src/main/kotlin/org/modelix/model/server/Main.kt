...
object Main {
    ...
    fun main(args: Array<String>) {
        ...
        try {
            ...
            LOG.info("Port: $port")
            val storeClient: IGenericStoreClient<ObjectInRepository>
    ...
    private class DumpOutThread internal constructor(storeClient: IGenericStoreClient<ObjectInRepository>, dumpName: String) :
        Thread(
            Runnable {
                try {
